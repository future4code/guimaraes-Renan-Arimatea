...
console.log(apresentacao("Renan", "09/10/1995"));

//--------------------------------------Ex2-------------------------------------------------------------//
function exercicio2(parametro: any): void {
...
type filme = {
  ...
  anoLancamento: string | number | undefined;
  genero: string;
  pontuacao?: string | number | undefined;
};
...
console.log(exercicio3("Duna", 2021, GENERO.ACAO, 74));
...
const empregados: Array<Colaborador> = [
  ...
  { name: "Salete", salary: 2200, session: SETORES.FINANCEIRO, localWork: true },
